...
# Version: 2026.1
# Thank you for using GenomeFetch!
# Note: Use this at your own risk, did not test this on MacOS.
###############################################################################
usage() {
  echo ""
  echo "GenomeFetch: a fast, user-friendly bacterial genome aasembly retrieval tool for RefSeq and GenBank."
  echo ""
  echo "USAGE:" 
...
echo "Thank you for using GenomeFetch! Have a good day!"
echo ""
